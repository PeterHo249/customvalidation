...
namespace CustomValidation
{
    ...
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            MonoValidate monoValidate = Builder.Instance.RuleFor(candidate).IsNotNull("Khong dc rong").IsEmail("Khong phai email").GetProduct();
            monoValidate.Validate(candidate);
