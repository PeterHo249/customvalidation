...
namespace CustomValidation
{
    public class GreaterValidator : Validator
    {
        ...
        public GreaterValidator(dynamic opposer, string message = null) : base(message)
        {
            _opposer = opposer;
        }
        ...
        public override ValidateException Validate(dynamic candidate)
        {
            ...
            else
            {
                ...
                {
                    //return new ValidateException(ExceptionType.NOT_GREATER, _message);
                    ValidateException ex = Builder.exceptionFactory.GetValidateException(ExceptionType.NOT_GREATER);
                    if (_message != null)
                        ex.Message = _message;
                    return ex;
                }
